...
import demoLogo from "../../assets/box.jpg";

import "./fixedvideoeditor.css";
const interact = require('interactjs')



class FixedVideoEditor extends Component {
    ...
    videoControll = (type) => {
        let vid = document.getElementById("editingVideoFile");
        if (type == "play") {
            vid.play();
        } else {
            vid.pause();
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="video-editor-ground"
                    style={{ width: "800px", height: "500px", background: "yellow" }}>
                    <div className="video-editor draggable-logo">
                        <div
                            className="resizable-logo"
                        >
                            <video
    ...
    <button onClick={() => this.videoControll("play")}>Play</button>

                    <button onClick={() => this.videoControll("pause")}>Pause</button>
                </div>
